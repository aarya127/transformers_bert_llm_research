...
OUTPUT_FILE = "/Users/aaryashah/Documents/GitHub/transformers_bert_llm_research/pivot_point/counterfactual_results.csv"
...
print("="*80)
print(f"Total cost: ${summary_df['cost_total_usd'].sum():.2f}")
